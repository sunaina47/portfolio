        ...
        <Card className="about-card" variant="borderless">
          <Row gutter={[16, 16]} justify="center" align="middle">
            <Col xs={24} md={12} className="about-text">
              Hello! 👋 I'm Sunaina Kharangate, a passionate Software Engineer
              with a keen interest in building dynamic and user-friendly web
              applications. I love crafting clean, efficient, and responsive UI
              ...
              on exciting challenges. Whether it's modern UI/UX design, frontend
              performance optimization, or full-stack development, I strive to
